  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Crowdfunding on Ethereum Blockchain"
        />
      ...
      <main className={styles.main}>
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} align={"left"}>
          ...
          <Heading
            ...
            py={4}
          >
            Crowdfunding using the powers of <br />Blockchain{" "}
          </Heading>
        ...
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} id="howitworks">
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} py={8}>
            <Feature
              ...
              text={
                "Enter a few details about the funds you are raising for."
              }
            />
            <Feature
              ...
              text={
                "All you need to do is share the Campaign to changemakers. Trust the people!"
              }
            />
            <Feature
